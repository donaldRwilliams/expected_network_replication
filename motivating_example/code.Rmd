...
for(i in 1:5000){
  ...
  Y1 <- MASS::mvrnorm(n = 1000, mu = rep(0, 4), Sigma = cors)
  Y2 <- MASS::mvrnorm(n = 1000, mu = rep(0, 4), Sigma = cors)
  Y3 <- MASS::mvrnorm(n = 1000, mu = rep(0, 4), Sigma = cors)
  Y4 <- MASS::mvrnorm(n = 1000, mu = rep(0, 4), Sigma = cors)


  cor_pvalues1 <- ifelse( cor_test(cor(Y1), n = 1000, c = 0)[upper.tri(diag(4))] < 0.05, 1, 0)
  cor_pvalues2 <- ifelse( cor_test(cor(Y2), n = 1000, c = 0)[upper.tri(diag(4))] < 0.05, 1, 0)
  cor_pvalues3 <- ifelse( cor_test(cor(Y3), n = 1000, c = 0)[upper.tri(diag(4))] < 0.05, 1, 0)
  cor_pvalues4 <- ifelse( cor_test(cor(Y4), n = 1000, c = 0)[upper.tri(diag(4))] < 0.05, 1, 0)



  res_cor2 <- as.data.frame( t(rbind(cor_pvalues1, cor_pvalues2)))
  res_cor2$tally  <- rowSums(res_pcor2)
  ...
  pcor_pvalues1 <- ifelse(cor_test(corpcor::cor2pcor(cor(Y1)), n = 1000, c = 2)[upper.tri(diag(4))] < 0.05, 1, 0)
  pcor_pvalues2 <- ifelse(cor_test(corpcor::cor2pcor(cor(Y2)), n = 1000, c = 2)[upper.tri(diag(4))] < 0.05, 1, 0)
  pcor_pvalues3 <- ifelse(cor_test(corpcor::cor2pcor(cor(Y3)), n = 1000, c = 2)[upper.tri(diag(4))] < 0.05, 1, 0)
  pcor_pvalues4 <- ifelse(cor_test( corpcor::cor2pcor(cor(Y4)), n = 1000, c = 2)[upper.tri(diag(4))] < 0.05, 1, 0)
...
results <- rbind(
do.call(rbind.data.frame, pcor2_ls),
do.call(rbind.data.frame, pcor3_ls),
do.call(rbind.data.frame, pcor4_ls),
do.call(rbind.data.frame, cor2_ls),
do.call(rbind.data.frame, cor3_ls),
do.call(rbind.data.frame, cor4_ls)
)
